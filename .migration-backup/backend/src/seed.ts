...
await withTransaction(async (client) => {
  ...
  const funds = [
    ["MUMBAI", "صندوق مومباي", "صندوق مومباي", "استثمار ذكي .. لعوائد أسرع", 3, 3.08, 5, "cyan", 1],
    [
      "NEWMEXICO",
      "صندوق نيو مكسيكو",
      "صندوق نيو مكسيكو",
    ...
    ["GXR", "صندوق GXR", "صندوق GXR", "استثمار عالمي .. بعوائد مستقرة", 30, 6.4, 5, "gold", 3],
    ["NBL", "صندوق NBL", "صندوق NBL", "نمو مستدام .. لثروتك المستقبلية", 160, 10.8, 5, "purple", 4],
  ];
